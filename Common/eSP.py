...
class eSP(Enum):
    ...
    proc_Reception_GetReception = 15
    proc_Reception_GetReceptionBoard = 16
    proc_Reception_SetReception = 17
    proc_Reception_CancelReception = 18
    proc_Reception_SetReceptionByRES = 19
    proc_Insurance_GetInsurance = 20
    proc_Insurance_SetInsurance = 21
    proc_Pay_GetPay = 22
    proc_Pay_SetPay = 23
